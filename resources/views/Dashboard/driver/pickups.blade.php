...
<div class="card">
    ...
    <div class="card-body pt-0">
        <div id="kt_view_search" class="collapse">
            <form action="{{ route('driver.pickups') }}" method="GET">
                <div class="row">
        ...
        <!--begin::Table-->
        <table class="table d-md-table d-block overflow-auto align-middle table-row-dashed fs-6 gy-5">
            <!--begin::Table head-->
            <thead>
                <!--begin::Table row-->
            ...
            <tbody class="text-gray-600 fw-bold">
                ...
                @foreach ($assignedPickups as $assigned)
                <tr>
                    <!--begin::Checkbox-->
                    {{-- <td>
                    ...
                    @endif
                    <td>
                        @if($assigned->pickup->driver_settled)
                    ...
                    <td>
                        {{ $assigned->pickup->package }}
                    </td>
                    <td>{{$assigned->pickup->date}}</td>

                    <td>
                        <div class="badge badge-light fw-bolder">{{$assigned->pickup->name}}</div>
                    </td>


                    <td>{{$assigned->pickup->phone}}</td>
                    ...
                    <td class="text-end">
                        ...
                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4"
                            ...
                            <div class="menu-item px-3">
                                <a href="{{route('pickup.show',$assigned->pickup->id)}}" class="menu-link px-3">show</a>
                            </div>
                            {{-- <div class="menu-item px-3">
        ...
        {{ $assignedPickups->appends(request()->all())->links() }}
        <!--end::Table-->
    </div>
    <!--end::Card body-->
</div>
