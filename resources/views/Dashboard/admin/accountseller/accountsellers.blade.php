    ...
    <div class="card-body pt-0">
        ...
        <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
            ...
            <tbody class="text-gray-600 fw-bold">
                ...
                @elseif($shipment->shippment_id == null)
                <tr>
                    <!--begin::Checkbox-->
                    {{-- <td>
                        <div class="form-check form-check-sm form-check-custom form-check-solid">
                    ...
                    <!--end::User=-->
                    <td>{{$shipment->pickup->created_at}}</td>
                    <td>{{$shipment->pickup->status}}</td>
                    {{-- <td>
                    ...
                    <td>{{$shipment->pickup->address->city->city}}</td>

                    <td>{{$shipment->pickup->address->area->area}}</td>
                    <td>--</td>
                    {{-- @foreach ($shipment->shippment->user->specialprices as $item)
