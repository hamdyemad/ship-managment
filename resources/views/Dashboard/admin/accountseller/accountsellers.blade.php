                ...
                <form method="get" action="{{route('accountseller_pdf')}}">
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <button type="submit" id="button12" class="btn btn-secondary">export</button>
                            </div>
                        </div>
                    </div>
                </form>
                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                <div class="mb-10 mt-5">
                                    ...
                                    <a href="{{ route('account.index') }}" class="btn btn-danger">{{ __('site.reset') }}</a>
                                </div>
                            </div>
                        </div>
                    </form>
                    ...
                    @else
                        <tr>
                            ...
                            <td class="d-flex align-items-center">
                                ...
                                <div class="d-flex flex-column">
                                    <a class="text-gray-800 text-hover-primary mb-1 view_data" id="{{$account->id}}"
                                        href="{{route('account.show',$account->pickup->id)}}"
                                        >{{$account->pickup->id}}</a>
                                </div>
                                <!--begin::User details-->
                            </td>
