            ...
            <div class="col-xxl-4">
                ...
                <div class="card card-xxl-stretch">
                    ...
                    <div class="card-body p-0">
                        <!--begin::Chart-->
                        <div class="" data-kt-color="danger" style="height: 70px"></div>
                        <!--end::Chart-->
                        <!--begin::Stats-->
                                    ...
                                    <div class="mb-10">
                                        ...
                                        <div>
                                            <select class="form-select form-select-solid" data-kt-select2="true"
                                                ...
                                                data-dropdown-parent="#kt_menu_61356e958c2c4" data-allow-clear="true">
                                                <option></option>
