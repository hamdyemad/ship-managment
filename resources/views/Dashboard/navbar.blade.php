    ...
    <div class="header-menu align-items-stretch" data-kt-drawer="true" data-kt-drawer-name="header-menu"
        ...
        {{-- <div
            ...
            <div class="menu-item me-lg-1">
                <a class="menu-link active py-3" href="{{route('app')}}">
        ...
        {{-- <div
            ...
            id="#kt_header_menu" data-kt-menu="true">
            <div class="menu-item me-lg-1">
                <a class="menu-link active py-3" href="{{route('open.scan')}}">
                    <span class="menu-title">{{__('site.scan')}}</span>
                </a>
            </div>
        </div> --}}
        ...
        {{-- <div
            ...
            id="#kt_header_menu" data-kt-menu="true">
            <div class="menu-item me-lg-1">
                <a class="menu-link active py-3" href="{{route('employee.scan')}}">
                    <span class="menu-title">{{__('site.designation')}}</span>
                </a>
            </div>
        </div> --}}
                ...
                <div data-kt-menu-trigger="click" data-kt-menu-placement="bottom-start"
                    ...
                    <div id="navmenu"
                        ...
                        @if(Auth::guard('admin')->check() || Auth::guard('employee')->check())
                            <div class="menu-item">
                                <a class="menu-link py-3" href="{{route('employee.scan')}}"
                                    title="scan to select driver to shippment" data-bs-toggle="tooltip" data-bs-trigger="hover"
                                    ...
                                    <span class="menu-title">{{ __('site.assign_shippment') }}</span>
                                </a>
                            </div>
                            <div class="menu-item">
                                <a class="menu-link py-3" href="{{route('employee.shippment')}}"
                                    ...
                                    <span class="menu-title">{{ __('site.change_shippment_status') }}</span>
                                </a>
                            </div>
                        @endif
                    </div>
                    ...
                    <div id="navmenu2"
                        ...
                        <div class="menu-item">
                            <a class="menu-link py-3" href="{{route('shipment.create')}}" title="Add new shippment"
                                ...
                                <span class="menu-title">{{ __('site.shippment') }}</span>
                            </a>
                        </div>
                        <div class="menu-item">
                            <a class="menu-link py-3" href="{{route('pickup.create')}}" title="Add new pickup "
                                data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click"
                                data-bs-placement="right">
                                <span class="menu-icon">
                                    <!--begin::Svg Icon | path: icons/duotune/abstract/abs027.svg-->
